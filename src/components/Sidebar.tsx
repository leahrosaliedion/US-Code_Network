        ...
        <div className="p-4 border-b border-gray-700">
          ...
          {graphSettingsExpanded && (
            <>
              ...
              <div className="mb-4">
                <label className="block text-sm text-gray-400 mb-2">
                  Maximum hops in subgraph: {maxHops === null ? 'Any' : maxHops}
                </label>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Show only nodes with at least this many connections.
                </p>
              </div>
            </>
          )}
              ...
              <form onSubmit={handleKeywordSubmit} className="mb-0">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="e.g., income, penalty, exemption"
